...
public abstract class BuffManager
{
    ...
    public BuffManager(Buff _buff, GameObject _target)
    {
        buff = _buff;
        target = _target;
    }
     ...
     */
    public virtual void Trigger(Buff.TriggerType triggerType = default, GameObject target = null)
    {
